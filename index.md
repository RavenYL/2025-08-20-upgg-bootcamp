...
address: "Wed-Thu, Aug 20-21: MSRB3 Room 1125<br>
                    (TBD)Fri, Aug 22: GSRB1 Room 4002 (Front sign says <q>Snyderman Genome Science Research Building</q>)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
<p>
<p>
As genetic techonology advances and the demand for analyzing larger data grows, it is pivotal to develop computational skills. You need basic command line knowledge to operate powerful bioinformatic software and tools, as well as some coding to make both impactful and aesthetically appealing visualizations of your research. In this bootcamp, we will touch on basic command lines in Unix and how to manipulate and visualize data in R. Since the best way to learn programming is to try it yourself, we focus on live-coding and project work. We hope that students with less prior knowledge will be able to familiarize themselves with the material, and that students with more prior knowledge will benefit from a review. Please explore and utilize your skills freely for your projects, whether you choose to do an individual or group project. This bootcamp is mostly student-run and is instructed by peer instructors -- PhD students in UPGG. All of us were, at one point, sitting where you are!
</p>  
